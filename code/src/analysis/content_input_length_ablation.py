...
from config import ModelConfig, AvailableDataset, saved_model_parameter_ablation_base_path, cached_dir, pretrained_model_path
from model.action_processing import ActionProcessor
from myio.data_reader import DBReader

# model_name_or_path = 'allenai-specter'
# model_name_or_path = 'dmis-lab/biobert-v1.1'
# model_name_or_path = os.path.join(pretrained_model_path, 'scibert_scivocab_uncased')
all_model_paths = ['allenai-specter', 'dmis-lab/biobert-v1.1', os.path.join(pretrained_model_path, 'scibert_scivocab_uncased')]
all_max_seq_lengths = [40, 80, 120, 160, 200, 240]
# all_max_seq_lengths = [50, 100, 150, 200, 250, 300, 350, 400, 450, 500]
...
for model_name_or_path in all_model_paths:
    ...
    for max_seq_length in all_max_seq_lengths:
        ...
        try:
            ...
            processor.fine_tune(save_model_path=save_model_path, model_config=params)
            print()
