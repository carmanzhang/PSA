...
Entrez.email = "126523546@163.com"
existing_pm_ids = [json.loads(line.strip())['pm_id'] for line in open('pubmed_official_similar_paper_bulk.tsv')]
existing_pm_ids = set(existing_pm_ids)
print(len(existing_pm_ids))

pm_id_arr = [line.strip() for line in open('data/pm_id_temp.tsv')]
print(len(pm_id_arr))
...
fw = open('pubmed_official_similar_paper_bulk.tsv', 'a')
