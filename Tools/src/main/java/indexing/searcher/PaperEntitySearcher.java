...
import indexing.entity.SearchResult;
import indexing.utils.DBUtil;
import indexing.utils.JsonUtil;
...
//        System.out.println("search key: " + line);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sql = "select pm_id, original_mesh, original_reference, original_mesh_reference, enhanced_mesh, enhanced_reference, enhanced_mesh_reference from sp.pubmed_paper_content_entity_data_for_indexing_searching where length(function) > 0;";
        ...
        try {
            ...
            while (rs.next()) {
                cnt += 1;
                if (cnt % 100 == 0) {
                    System.out.println("Count: " + cnt / 100);
                }
